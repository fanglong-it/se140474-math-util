...
public class mathUtil {
    ...
    public static void main(String[] args) {
        //tui mún test xem 5! có bằng 120 hem ?
...
//VỚI 3 CÁCH NÀY, ra gọi hàm, nhìn kết quả trả về của hàm - ACTUAL VALUE
//  và ta ngầm so sánh với các kết quả mà ta tự tính toán trước đố
//  khi chưa gọi hàm - ta gọi là GIÁ TRỊ KÌ VONG - EXPECTED VALUE
// nết EXPECTED VALUE == ACTUAL VALUE (thực tế và kì vọng khớp nhau)
// Á ĐÙ, HÀM NÀY CHẠY ĐÚNG
// nếu ko bằng, ĐÙ, HÀM XỬ LÍ SAI
// 3 CÁCH TRÊN ĐÒI HỎI DEV DÙNG MẮT ĐỂ LUẬN KẾT QUẢ ĐÚNG SAI
...
// VÀ NẾU TẤT CẢ CÁ TÌNH HUỐNG ĐỀU KHỚP, BẰNG NHAU, NÉM RA 1 MÀU XANH
// NẾT HẦY HẾT ĐỀU KHỚP, CHỈ CÓ ÍT NHẤT 1 CÁI KHÔNG KHỚP, HÀM KO ỔN ĐỊNH
// NÉM RA MÀU ĐỎ -> CÁNH BÁO DÂN DEV CODE CÓ TRỤC TRẶC
...
// THƯ VIEẸN NÀY ĐỀU CÓ TƯƠNG  ỨNG Ở CÁC NGÔN NGỮ LẬP TRÌNH
// JAVA: JUnit, TestNG....
